		...
		archetypes[archetype_id]
			...
			.unwrap_or_else(|| {
				...
				match (
					...
					(new_table_components_empty, new_sparse_set_components_empty) => {
						let table_id;
						...
						// the archetype changes when we add this bundle. prepare the new archetype and storages
						{
							...
							table_components = if new_table_components_empty {
							...
							sparse_set_components = if new_sparse_set_components_empty {
								current_archetype
