...
use bevy_render::{
	...
	render_resource::{Face, FilterMode, PrimitiveTopology, SamplerDescriptor},
...
use crate::{conversions::*, Gltf, GltfNode};
	...
	fn from_world(world: &mut World) -> Self {
		Self {
			supported_compressed_formats: world
				...
				.map(CompressedImageFormats::from)
				.unwrap_or_else(CompressedImageFormats::all),
		}
	}
}
