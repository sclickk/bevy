...
mod splash {
	...
	impl Plugin for SplashPlugin {
		fn build(&self, app: &mut App) {
			...
			app.add_system_set(SystemSet::on_update(GameState::Splash).with_system(countdown));
...
mod game {
	...
	impl Plugin for GamePlugin {
		fn build(&self, app: &mut App) {
			...
			app.add_system_set(SystemSet::on_update(GameState::Game).with_system(game));
			app.add_system_set(
...
mod menu {
	...
	impl Plugin for MenuPlugin {
		fn build(&self, app: &mut App) {
			...
			app.add_system_set(
				SystemSet::on_exit(MenuState::Settings).with_system(despawn_screen::<OnSettingsMenuScreen>),
			);
	...
	fn setting_button<T: Component + PartialEq + Copy>(
		...
		for (interaction, button_setting, entity) in interaction_query.into_iter() {
	...
	fn menu_action(
		...
		for (interaction, menu_button_action) in interaction_query.into_iter() {
...
fn despawn_screen<T: Component>(to_despawn: Query<Entity, With<T>>, mut commands: Commands) {
	for entity in to_despawn.into_iter() {
